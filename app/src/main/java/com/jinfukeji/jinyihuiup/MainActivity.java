...
import com.jinfukeji.jinyihuiup.fargment.HangQingActivity;
import com.jinfukeji.jinyihuiup.fargment.MyActivity;
import com.jinfukeji.jinyihuiup.fargment.ShouYeActivity;
import com.jinfukeji.jinyihuiup.fargment.XueyuanActivity;
...
public class MainActivity extends FragmentActivity implements View.OnClickListener {
    ...
    public void setChioceItem(int chioceItem) {
        ...
        switch (chioceItem){
            case 0:
                ...
                index_image.setImageResource(R.mipmap.shouye);
                if (index==null){
                ...
                break;
            case 1:
                xueyuan_text.setTextColor(Blue);
                xueyuan_image.setImageResource(R.mipmap.xueyuan);
            ...
            case 2:
                ...
                break;
            case 3:
                hangqing_txt.setTextColor(Blue);
                hangqing_image.setImageResource(R.mipmap.hangqinga);
    ...
    private void clearColor() {
        ...
        hangqing_image.setImageResource(R.mipmap.hangqing_u02);
    }
}
