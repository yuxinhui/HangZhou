...
import com.jinfukeji.jinyihuiup.bean.GuPiaoMsgData;
import com.jinfukeji.jinyihuiup.indexBannerClick.GuPiaoActivity;
import com.jinfukeji.jinyihuiup.indexBannerClick.ShenGuActivity;
...
public class GupiaoMessage extends AppCompatActivity {
    ...
    private String urlGuPiaoMsg= JinYiHuiApplication.URL_BOOT+"app/share?code=";
