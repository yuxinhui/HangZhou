...
import com.jinfukeji.jinyihuiup.bean.DailiBean;
import com.jinfukeji.jinyihuiup.bean.Message;
import com.jinfukeji.jinyihuiup.bean.SmsMessage;
import com.jinfukeji.jinyihuiup.bean.User;
import com.jinfukeji.jinyihuiup.utils.DialogUtils;
import com.jinfukeji.jinyihuiup.utils.VerCodeTImer;
...
public class Zhuce extends AppCompatActivity {
    ...
    private void onClick() {
        metVadateCode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url_getcode = JinYiHuiApplication.URL_BOOT + "user/tel_code?telephone=" + telepone;
        ...
        zhuce_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url_daili = JinYiHuiApplication.URL_BOOT + "agent/findAll?code=" + metGid.getText().toString();
                getDaili(url_daili);
                return;
            }
        });
    ...
    public void getDaili( String url_daili) {
        ...
        queue.add(request);
        String url = JinYiHuiApplication.URL_BOOT + "user/register" + "?telephone=" + telepone + "&password=" + password + "&tel_code=" + validateCode + "&gid=" + gid;
        register(url);
    }
            ...
            public void onResponse(String s) {
                if (s != null) {
                    if (s.contains("ok")) {
                        ...
                        JinYiHuiApplication.getInstace().setUser(user);
