package com.jinfukeji.jinyihuiup.adapter;
...
import com.jinfukeji.jinyihuiup.utils.ChatEmojiParser;
import com.jinfukeji.jinyihuiup.utils.NetUtil;
import com.jinfukeji.jinyihuiup.utils.RequestManager;
import com.jinfukeji.jinyihuiup.utils.ZhiboImgSizeUtil;
...
public class ChatAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(message.getType()==ShowMessaage.MESSAGE_TYPE_SEND_IMAGE){
            ...
            if(message.getContent().contains(JinYiHuiApplication.URL_BOOT)){
