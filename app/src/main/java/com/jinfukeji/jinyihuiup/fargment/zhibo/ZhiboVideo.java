...
import com.jinfukeji.jinyihuiup.bean.ZhiboVideoData;
...
public class ZhiboVideo extends Fragment {
    ...
    private String videoUrl= JinYiHuiApplication.URL_BOOT+"app_online?gid="+JinYiHuiApplication.getInstace().getUser().getId();
    @Nullable
    @Override
